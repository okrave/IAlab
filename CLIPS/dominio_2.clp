...
(deffacts DOMANDE::lista-domande
    ...
    ;; Iterazione 2
    (domanda (descrizione budget-viaggio-generico)(importanza 2) (la-domanda "Hai un budget massimo? [Si, No]") (risposte-valide si no))
    (domanda (tipo range)(descrizione budget-viaggio)(importanza 2) (la-domanda "Qual'è il tuo budget? valore tra [200,5000]") (risposte-valide 200 5000)(precursori budget-viaggio-generico is si))
    (domanda (descrizione viaggio-piu-regioni-generico)(importanza 2) (la-domanda "Vuoi visitare più regioni? [Si, No]") (risposte-valide Si No si no))
    (domanda (descrizione sport-termale)(importanza 2)(la-domanda " In vacanza vuoi rilassarti o mantenerti attivo facendo sport ? [relax sport] ")(risposte-valide relax sport))


    ;; Iterazione 3
    (domanda (descrizione numero-location-generico) (importanza 3) (la-domanda "Vuoi visitare meno location? [Si,No]") (risposte-valide Si No si no))
    (domanda (descrizione viaggio-regione-generico) (importanza 3) (la-domanda "Vuoi visitare qualche regionee in particolare? [Si,No]") (risposte-valide Si No si no))
    (domanda (descrizione viaggio-regione) (importanza 3) (la-domanda "Quale regionee vorresti visitare? ") (risposte-valide sicilia calabria puglia toscana liguria lombardia piemonte lazio)(precursori viaggio-regione-generico is si))
    (domanda (tipo range)(descrizione numero-location)(importanza 3)(la-domanda "Quante città vuoi visitare?")(risposte-valide 1 7)(precursori numero-location-generico is si))
...
(defrule location-turism-list-random-creation
    ...
    (assert(location-turistica (nome-location ?n)(tipo-turismo religioso)(score  (random 1 5))))
